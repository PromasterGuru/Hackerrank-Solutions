...
if __name__ == "__main__":
    test_time = [2.73, 2.79, 20.1, 100, 5.56, 6, 1.3, 4]
    arr = [100, 50, 20, 10, 5, 2.5, 1, 0.5, 0.1, 0.05, 0.02, 0.01]
    for target in test_time:
        print("{} : {}".format(target,solution(arr, target)))
